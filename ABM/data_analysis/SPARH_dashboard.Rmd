...
#setwd("Desktop/opioid_research/SPARH_model/data_analysis") # Set to wd
...
abm_data = "SPARH_data/SPARH_ABM_SU2020_5_19_afternoon heroin_run-table.csv"
ode_data = "SPARH_data/HeroinODE.csv"
...
nv = as.numeric(vals)
# nv = trunc(nv * 10^4)/ 10^4
#icdf = data.frame(Variable = nm, Initial_Value = nv)
...
#kable(icdf[which(nm %in% c("turtle.count", "initial_S", "initial_P")),])
#xtable(icdf[which(nm %in% c("turtle.count", "initial_S", "initial_P")),])
#icdf["initial_P",]
#icdf["initial_S",]
kable(icdf_overall)
```
