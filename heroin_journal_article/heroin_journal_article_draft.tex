...
(literature information and parameter estimation) 
 ...
 \textcolor{blue}{Applying model to Tennessee population/start to talk about Tennessee specifically} \\
We apply our model to the Tennessee population specifically in order to analyze the opioid epidemic on a smaller scale than the national level. Although there is still heterogeneity across Tennessee, it is lower than the amount one would find on a national scale. \textcolor{red}{Put in information of US prescription rate per capita at it's peak was 81.3/100 people and how TN has been far above that every year...Talk about why applying to Tennessee specifically-worse state than others.}
