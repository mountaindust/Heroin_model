...
% 91\% of prescription opioid users relapsed back to addiction within 8 weeks post-treatment \cite{Weiss}. We were not able to find information on the relapse rate specifically within 4 weeks after treatment for prescription opioid addicts; we assume it is approximately the same as heroin for this short of a time frame, especially due to the acute withdrawal phase of the first few weeks discussed before in \cite{Gossop1}.
...
$$\frac{1 \text{ HA in treatment}}{10 \text{ HA}} \cdot \frac{53.4 \text{ HA complete treatment}}{100 \text{ HA in treatment}} \cdot \frac{29 \text{ HA do not relapse within 4 weeks post-treament}}{100 \text{ HA completed treatment}}$$
$$\implies \nu \approx  0.0155.$$

%The exact calculation can be done for opioid addicts, as well, to obtain $ \zeta \approx  0.0155.$ 
