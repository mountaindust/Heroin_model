...
\textcolor{red}{Think about these data points again: would they include addicted individuals, as well? Only some are addicted; make estimate of how many take prescriptions AND are addicted to be able to subtract out of here? Would need to know what percentage of prescription opioid users are addicted and subtract that number of people out?}
