...
\textcolor{red}{Reminder: use present tense, use powerful/direct language.} \\
\textbf{Abstract} \\ \\
...
\textcolor{red}{``Group" other models after 4 sentences of White and Comiskey (for paper). Say ``other models include..." or ``Approaches also include...agent-based modeling, etc." Or ``of interest is..."} \\
...
3. Opioid addicts $A$: This group of individuals are addicted to opioids, but not using heroin or fentanyl, or are actively in treatment for opioid addiction. For individuals who go to treatment for opioid addiction, they remain in this class for 4 weeks after treatment. (Although the opioid class of drug includes heroin and fentanyl, here we take opioids to mean non-heroin and non-fentanyl.) \\ \\
4. Heroin/fentanyl users $H$: This class is composed of individuals who are addicted to heroin or fentanyl, or are actively in treatment for heroin/fentanyl addiction. For individuals who go to treatment for heroin/fentanyl addiction, they remain in this class for 4 weeks after treatment. We note that individuals in this class could be using other drugs or are addicted to opioids in addition to heroin or fentanyl, but they are at least addicted to one of these drugs. \\ \\
...
\vspace{.05cm}
\[S+P+A+H+R=1 \quad(6).\]
\textcolor{red}{See best way to write this last equation?}
...
The parameter estimation codes right now reflect recent changes of the model (including the terms $\sigma R \frac{A}{A+H+\omega}$ and $\sigma R \frac{H}{A+H+\omega}$) and runs from 2013-2017. Currently we only have 7 data points and 15 unknowns, but 3 more data points can be put in now for a total of 10 data points. If we run from 2015-2017, we would have 9 data points total and 12 unknowns.  \\ \\ 
%\textcolor{red}{Put in 2014-2015 heroin addicts =14,000 (from Table 95: 2014/2015 heroin addict information:} 
...
\textcolor{red}{Put in 2014-2015 heroin addicts =14,000 from Table 95: 2014/2015 heroin addict information into data tables and code} \\
%https://www.samhsa.gov\linebreak/data/sites/default/files/NSDUHsaeStateTabs2015B/NSDUHsaeSpecificStates2015.htm

\textcolor{red}{Put in 2016-2017 opioid addicts: 42,000 and 2016-2017 heroin addicts: 19,000 from NSDUHsaeTennessee2017 (already downloaded on laptop) into data tables and code}  
...
Opioid Addicts & - & - & 48,000 & \textcolor{red}{42,000} & - &-\\
Heroin Addicts & - & \textcolor{red}{14,000} & 14,000 & \textcolor{red}{19,000}  & - &-\\
...
\label{tab:template}
\end{center}
 \textcolor{red}{Those in red: still need to incorporate in code.}
...
The \textbf{total number of individuals taking prescription opioids} for pain is given in the third row \cite{TNgov1}. \\
...
\textcolor{red}{Think about these data points again: would they include addicted individuals, as well? Only some are addicted; make estimate of how many take prescriptions AND are addicted to be able to subtract out of here?}
