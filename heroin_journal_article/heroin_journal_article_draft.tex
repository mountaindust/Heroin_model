...
\textcolor{red}{Edit Non-addicted Prescription Opioid Users}& 1,660,630 &1,641,908 & 1,637,623 & 1,585,227 &  1,472,737 &-\\
...
Given the data presented in Table 1, we approximate the initial conditions of our states for 2013. There were 1,845,144 total individuals 12 and older who were prescribed opioids (which includes those addicted) at some point during 2013. %data table 
There were 8,525,017 prescriptions filled in Tennessee in 2013 out of a total population of 6,490,795 people, which results in an average of 1.313 prescriptions per person. Although this is a per capita rate, we will assume it also holds when only considering the population of 12 years old and older, in order to work with our previous data. %IMS, had to make remark about using 12 and older population instead of total population because they did data based on "per capita" as seen in fourth column 
Thus, we calculate 
$$\frac{1.313 \text{ prescriptions}}{\text{person$\cdot$ year}}\cdot \frac{5,517,176 \text{ people}}{1,845,144 \text{ prescription users}} \approx \frac{ 3.93 \text{ prescriptions}}{\text{prescription user $\cdot$ year }}.$$  %TN opioid summary
In 2013, the average number of days of supply per prescription at the national level was approximately 16.5 days. %CDC online 
Thus, this means there are 
$$\frac{3.93 \text{ prescriptions}}{\text{prescription user $\cdot$ year}} \cdot \frac{{16.5 \text{ prescription days}}}{\text{prescription}} \approx \frac{64.85 \text{ prescription days}}{\text{prescription user $\cdot$ year}} $$
