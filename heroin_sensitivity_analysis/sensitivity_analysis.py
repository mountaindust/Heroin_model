    ...
    if reduced:
        ...
        problem = {
            ...
            'names': ['m', 'beta_A', 'beta_P', 'theta_1', 'epsilon', 
                      ...
                      'b','P_0', 'A_0', 'H_0', 'R_0'],
            'bounds': [[-0.00255,-0.00085], [0.0001365,0.0004095], [0.0003885,0.0011655], [0.000001,0.001], [1.68,5.04], 
                       [0.0001,0.1], [0.0001,0.1], [0.00434,0.01302], [0.00435,0.01305], [0.02535,0.07605], 
                       [0.000204,0.1], [0.0107,0.0321],  [0.001,0.9], [0.00775,0.02325], [0.00000000005,0.00000000015], 
                       [0.1465,0.4395], [0.0355,0.2], [0.0037,0.0111], [0.000755,0.002265], [0.0002585,0.0007755]] 
        }
