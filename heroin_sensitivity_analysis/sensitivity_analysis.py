    ...
    if reduced:
        ...
        problem = {
            ...
            'names': ['m', 'beta_A', 'beta_P', 'theta_1', 'epsilon', 
                      ...
                      'b','P_0', 'A_0', 'H_0', 'R_0'],
            'bounds': [[-0.1845,-0.00615], [0.0001365,0.0004095], [0.0003885,0.0011655], [0.000001,0.1], [1.545,4.635], 
                       [0.00001,0.5], [0.0001,0.9], [0.00434,0.01302], [0.00435,0.01305], [0.02535,0.07605], 
                       [0.000001,0.3], [0.0107,0.0321],  [0.00001,1.60], [0.00775,0.02325], [0.00000000005,0.00000000015], 
