    ...
    if reduced:
        ...
        problem = {
            ...
            'names': ['m', 'beta_A', 'beta_P', 'theta_1', 'epsilon', 
                      ...
                      'b','P_0', 'A_0', 'H_0', 'R_0'],
            'bounds': [[-0.0027,-0.0009], [0.000137,0.00041], [0.000389,0.00117], [0.000001,0.0001], [1.675,5.025], 
                       [0.0001,0.01], [0.0001,0.01], [0.00434,0.01302], [0.00435,0.0131], [0.0254,0.0761], 
                       [0.00001,0.001], [0.0107,0.0321],  [0.0001,0.01], [0.00775,0.0233], [0.00000000005,0.00000000015], 
                       [0.147,0.441], [0.0355,0.2], [0.00369,0.01], [0.000865,0.01], [0.0001,0.01]]  
        }
