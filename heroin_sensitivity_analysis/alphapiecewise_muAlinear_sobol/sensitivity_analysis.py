    ...
    if reduced:
        ...
        problem = {
            ...
            'bounds': [[-0.0084,-0.0028], [0.000439,0.001317], [0.0000327,0.0000981], [0.111,0.333], [1.265,3.795], 
                       ...
                       [0.135,0.405], [-0.038,-0.0135], [0.0004885,0.0014655], [0.004415,0.013245], [0.0475,0.1425], [0.00355,0.01065], [0.0002325,0.0006975], [0.002535,0.007605]]  
...
def plot_S1_ST_tbl(S_sens, P_sens, A_sens, H_sens, R_sens, show=True, ext='eps'):
    ...
    gs = gridspec.GridSpec(1, 3, width_ratios=[1.5,1.5,.5], wspace=.15, left=0.04,
