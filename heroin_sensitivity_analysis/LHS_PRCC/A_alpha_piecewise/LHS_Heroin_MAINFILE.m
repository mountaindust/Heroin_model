...
[prcc19 sign19 sign_label19] = PRCC_Heroin(LHSmatrix19,A_lhs19,1:length(time_points),PRCC_var,alpha);
[prcc20 sign20 sign_label20] = PRCC_Heroin(LHSmatrix20,A_lhs20,1:length(time_points),PRCC_var,alpha);
[prcc21 sign21 sign_label21] = PRCC_Heroin(LHSmatrix21,A_lhs21,1:length(time_points),PRCC_var,alpha);
