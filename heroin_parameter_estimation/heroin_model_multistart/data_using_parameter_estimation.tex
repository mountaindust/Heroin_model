...
\textit{italicized} values are numbers that we estimated by extrapolating from a different year \\
 \textbf{bolded} values are numbers that we estimated by information within the same year \\
...
Using MultiStart to obtain 7 values: \\
$[\alpha \ \theta_1 \ \epsilon \ \gamma \ \sigma \  \ H_0 \ R_0 ]$
