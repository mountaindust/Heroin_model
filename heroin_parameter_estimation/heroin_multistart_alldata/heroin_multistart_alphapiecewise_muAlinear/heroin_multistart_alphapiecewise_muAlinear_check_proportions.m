...
W0=0;
Z0=0;
initials = [S0;P0;A0;H0;R0;X0;L0;M0;J0;K0;W0;Z0];
...
%%Simulated in P class each year 
...
%Simulated in P class each quarter  
Estim4=y(1:24,2)+y(2:25,6)-y(1:24,6);

%Simulated overdoses from A each year
Estim5=[y(5,9)-y(1,9); y(9,9)-y(5,9); y(13,9)-y(9,9); y(17,9)-y(13,9)];

%Simulated overdoses from H each year
Estim6=[y(5,10)-y(1,10); y(9,10)-y(5,10); y(13,10)-y(9,10);...
        y(17,10)-y(13,10); y(21,10)-y(17,10)];
    
%Simulated in S class each year 
Estim7=[y(1,1)+y(5,11)-y(1,11); y(5,1)+y(9,11)-y(5,11); y(9,1)+y(13,11)-y(9,11);...
        y(13,1)+y(17,11)-y(13,11); y(17,1)+y(21,11)-y(17,11); y(21,1)+y(25,11)-y(21,11)];

%Simulated in R class each year 
Estim8=[y(1,5)+y(5,12)-y(1,12); y(5,5)+y(9,12)-y(5,12); y(9,5)+y(13,12)-y(9,12);...
        y(13,5)+y(17,12)-y(13,12); y(17,5)+y(21,12)-y(17,12); y(21,5)+y(25,12)-y(21,12)];
...
f(11) = pars(5)*y(2)+pars(6)*(y(2)+y(5))+(pars(6)+muA(t,pars))*y(3)+(pars(6)+pars(7))*y(4);

%Z' ODE to calculuate the number of new recovereds over time, i.e.
%individiausl who enter the R class at any time 
f(12) = pars(11)*y(3)+pars(13)*y(4);
