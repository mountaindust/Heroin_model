%This is heroin_alphaconstant_muAconstant_testing.m code WITH alpha piecewise linear,
%muA linear parameter values. Here, we fix alpha and mu_A as their 2013 values because
%time-varying parameters alpha and mu_A make the solutions of P and A go
%negative. If need to give information on this in future for a paper, maybe
%make a lower bound on alpha (i.e. at it's value in 2030) and use that lower bound as time gets large. 

alpha=0.270110337915851;
beta_A=0.000878431642350708;
beta_P=6.54313717400116e-05;
theta_1=0.222457489109919;
epsilon=2.52786996559537;
mu=0.00710; 
mu_A=0.00883138792481281;
mu_H=0.0466; 
