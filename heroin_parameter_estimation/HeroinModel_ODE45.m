...
[t,y]=ode45(@(t,y) HeroinModel(t,y,z),tspan,initials);
 ...
 % Yearly output from the model as a proportion of P individuals for 2013-final year
 Estim1=zeros(1,25);
 % For 2013:
 Estim1(1)=z(12)+y(1,6);  
 % For 2014-final year:
 ...
 % Yearly output from the model as a proportion of A individuals for 2013-final year
 Estim2=zeros(1,25);  
 % For 2013:
 Estim2(1)=z(13)+y(1,7);  
 % For 2014-final year:
 ...
 % Yearly output from the model as a proportion of H individuals for 2013-final year
 Estim3=zeros(1,25);  
 % For 2013:
 Estim3(1)=z(14)+y(1,8);  
 % For 2014-final year:
