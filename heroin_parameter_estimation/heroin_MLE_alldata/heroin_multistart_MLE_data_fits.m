...
for i=1:61;
    continuous1(i)=pars(21)*(y(i,2)+y(i+12,6)-y(i,6));
 end 
 
 for i=1:61;
    continuous2(i)=pars(19)*(y(i,3)+y(i+12,7)-y(i,7));
 end 
 
 for i=1:25;
    continuous3(i)=pars(19)*(y(i+12,4)+y(i+24,8)-y(i+12,8));
 end 
 
 for i=1:70;
    continuous4(i)=pars(21)*(y(i,2)+y(i+3,6)-y(i,6));
 end 
 
 for i=1:37;
    continuous5(i)=pars(19)*(y(i+12,9)-y(i,9));
 end 
 
 for i=1:49;
     continuous6(i)=pars(19)*(y(i+12,10)-y(i,10));
 end 
