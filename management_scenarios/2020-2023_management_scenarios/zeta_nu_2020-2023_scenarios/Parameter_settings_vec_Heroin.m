...
t_end= 3; % length of the simulations- 30 days
tspan=[0:1:3];   % time points where the output is calculated
time_points = 3; % time points of interest for the distemper analysis- amount of infected on last day = 30
...
PRCC_var={'beta_A','beta_P','theta_1','epsilon','gamma','sigma','mu','mu_H','theta_2','zeta','theta_3','nu','omega','g','h','P0','A0','H0','R0'};
