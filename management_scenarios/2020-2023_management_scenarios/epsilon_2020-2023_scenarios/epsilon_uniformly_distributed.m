...
for x=1:N;
 ...
 figure(1);
 plot((vec_matrix(:,4)-2.52786996559537)*100/2.52786996559537,(0.001681716135399-A_lhs(1,:))*100/0.001681716135399,'LineWidth',2) 
 hold on
 plot((vec_matrix(:,4)-2.52786996559537)*100/2.52786996559537,(0.013798429999561-H_lhs(1,:))*100/0.013798429999561,'LineWidth',2)
 ...
 disp('value of H with this epsilon value')
 H_lhs(1,entry)
 disp('percent decrease of H from baseline 2023 value with this new epsilon values')
