...
for x=1:N;
 ...
 %b-final time output of A from new b value divided by baseline final time output. Same
 %for H. 
 figure(1);
 plot((0.270110337915851-vec_matrix(:,15))*100/0.270110337915851,(0.004329295236935-A_lhs(1,:))*100/0.004329295236935,'LineWidth',2) 
 hold on
 plot((0.270110337915851-vec_matrix(:,15))*100/0.270110337915851,(0.004298941991162-H_lhs(1,:))*100/0.004298941991162,'LineWidth',2)
