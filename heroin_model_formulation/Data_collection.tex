...
\textcolor{red}{Does not specify if 12 and older, assume it's okay because TN Dept of Health info mostly seems to be?} 
...
\item Taking the total number of deaths and subtracting out overdose deaths for respective years results in the \textbf{total number of deaths, excluding overdoses} for individuals in Tennessee \cite{TNgov2, USCensus}: \\
