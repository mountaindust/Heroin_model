...
The \textbf{total number of deaths, excluding overdoses} for individuals in Tennessee (took total deaths and subtracted out overdose deaths for the respective years) [5,7]: 
...
\textcolor{red}{Edit because removed delta} \textbf{Proof of non-negative initial conditions guaranteeing non-negative solutions} \\
...
\textcolor{red}{Edit because removed delta} \textbf{Addiction-Free Equilibrium} 
...
\textcolor{red}{Edit because removed delta} \textbf{Basic Reproduction Number, \textbf{$\mathscr{R}_0$}}
