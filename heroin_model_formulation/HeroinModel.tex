...
$S(0)=S_{0}$, $P(0)=P_{0}$, $A(0)=A_{0}$, $H(0)=H_{0}$, and $R(0)=R_{0}$, and we assume all of these values are positive. From data, the initial values for each of the classes are the following proportions of the entire population, and therefore are dimension-less: \textcolor{red}{Fill in initial conditions for the population classes}. 

The following are the \textbf{number of individuals initially in each class} for Tennessee: \\
*Susceptibles: (Total population in 2015-size of four other classes$=6,590,726-1,819,581-70,000-14,000-R_{0}=$FILL IN) \cite{USCensus} \\
*Prescription opioid users, 2015: 1,819,581 \cite{TNgov1} \\
\textcolor{blue}{*Opioid addicts: \\
1) 2015/2016 average for ``Pain Reliever Use Disorder": 48,000 \cite{NSDUH2} \\
-dependence falls under our definition for addiction but not abuse from their definitions \\
%DSM: https://dsm.psychiatryonline.org/doi/pdf/10.1176/appi.books.9780890420249.dsm-iv-tr
2) 56,000 in 2010 \\
-Original website source not found $https://www.tn.gov/assets/entities/behavioral-health/sa/attachments/Prescription{\_}For{\_}Success{\_}SECTION{\_}1.pdf$. \\
-Several sources say 70,000 opioid addicts, such as American Addiction Centers \\ %https://americanaddictioncenters.org/rehab-guide/tennessee/
-Assuming opioid addicts includes heroin and fentanyl users, so took 70,000-14,000=56,000}
*Heroin/fentanyl addicts, 2015/2016 average for ``Past Year Heroin Use": 14,000 \cite{NSDUH2} \textcolor{applegreen}{(Also available for NJ)} \\ %NSDUH Info for how do surveys for states: https://www.samhsa.gov/data/sites/default/files/NSDUHsaeMethodology2016/NSDUHsaeMethodology2016.pdf
...
\item \textbf{Treatment admissions for prescription opioids} as primary substance of abuse in Tennessee \cite{TNMentalHealth}: \textcolor{blue}{Tennessee Dept of Mental Health and Substance Abuse Services-funded admissions to substance abuse treatment services which serves Tennessee residents age 12 and older, in poverty and have no other insurance coverage for substance abuse treatment and/or recovery services:}\\ %can get "new arrivals to R" from this info, apparently: integrate dR/dt over time frame interested in (t_1 to t_2) and on RHS, integrate \zeta*A+\nu*H (or can break into two integrals on the RHS), and can get new arrivals; don't have to worry about double counting or people cycling \\
2014: 4,145\\
2015: 4,085 \\
2016: 3,911 \\
%Additional treatment admissions data for Tennessee: https://wwwdasis.samhsa.gov/dasis2/teds_pubs/2015_teds_rpt_st.pdf

\textcolor{blue}{OR for \textbf{non-heroin opiates/synthetics} from \cite{TEDS1_SAMSHA} \\
2005: 1,578 \\
2006: 1,529 \\
2007: 1,743 \\
2008: 2,022 \\
...
2014: 4,530 \\
2015: 4,326 \\}
\textcolor{applegreen}{(Also available for NJ)}




\textcolor{red}{We assume that if one were addicted to heroin in addition to prescription opioids, their heroin problem would be the primary reason for going to treatment?}

\item \textbf{Treatment admissions for heroin} as primary substance of abuse in Tennessee \cite{TNMentalHealth}: \textcolor{blue}{Tennessee Dept of Mental Health and Substance Abuse Services-funded admissions to substance abuse treatment services which serves Tennessee residents age 12 and older, in poverty and have no other insurance coverage for substance abuse treatment and/or recovery services:}  \\
2014: 538 \\
2015: 826 \\
2016: 1,184 \\

\textcolor{blue}{OR from \cite{TEDS1_SAMSHA}: facilities that receive state/public funding  (generally referring to funding by the state substance abuse agency)} \\
\textcolor{blue}{2010: 199} \\
\textcolor{blue}{2011: 240} \\
\textcolor{blue}{2012: 390} \\
\textcolor{blue}{2013: 555} \\
\textcolor{blue}{2014: 743} \\
\textcolor{blue}{2015: 1,083} \\
\textcolor{applegreen}{(Also available for NJ)}
...
\item \textcolor{blue}{\textbf{Information for moving from recovery to opioid addiction or heroin/fentanyl addiction, $\sigma_A$ and $\sigma_H$:} \cite{TEDS2015_SAMSHA}}
\textcolor{blue}{\\
-Available for 2011-2015 \\
-Seems more realistic that the individuals who go back to an addiction are those who ``drop out" rather than ``1-number of individuals who complete the program" since the latter includes those who are incarcerated, died, transferred, etc. \\
-Number of ``Outpatient medication-assisted opioid therapy drop-outs"$=0$ for 2015 in TN \textcolor{applegreen}{(compare to NJ: 3,732)} \\
-Number of ``Medication-assisted opioid detox drop-outs"$=0$ for 2015 in TN \textcolor{applegreen}{(compare to NJ: 311)}  \\
-For ALL substance abuse treatment programs in TN: 3,039 dropped out out of 14,916 total admissions (extrapolate ratio to opioid related therapies?)}
\textcolor{applegreen}{(Also available for NJ)}
...
\textcolor{applegreen}{(Available for NJ from 2012-2017 for both heroin and fentanyl at https://nj.gov/oag/njcares/index2.html)}
...
\item The \textbf{total number of deaths, excluding overdoses} for individuals in Tennessee (took total deaths and subtracted out overdose deaths for the respective years) \cite{TNgov2, USCensus}: \\
...
\item \textcolor{blue}{For the 609,000 participants in the study, ``the recent heroin incidence rate was 19 times higher among those who reported prior non-medical pain reliever (NMPR) use (0.39\%) than among those who did not report NMPR use (0.02\%).} \cite{Muhuri} \\
\textcolor{blue}{$\implies$ ($\theta_2 + \theta_3$) 19 times greater than $\theta_1$?}
...
\textcolor{red}{Was unable to solve for endemic equilibrium...need to eventually or just prove existence of one? Bifuraction analysis?}
...
People: Met with Kelly Cooper, Laurie Meschke, Clea McNeely, Matthew Harris; Future connections?: Chris McCurty at the Florida Center for Excellence; Don Burke at University of Pittsburgh; Charles Simms from Economics dept at UT
\\ \\
