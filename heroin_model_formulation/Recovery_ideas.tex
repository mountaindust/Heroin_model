...
%Was not able to find relapse rate graph to understand shape and be better able to inform these rates.
...
Studies suggest that 91\% of prescription opioid addicts who complete recovery relapse back into addiction within 8 weeks (Weiss and Rao) and 70\% of heroin addicts relapse within 4 weeks (Smyth paper from Christopher?) \textcolor{red}{Although these are on a national level, we will assume the rates do not differ significantly for TN (for now)? Was not able to find any relapse statistics specifically for TN.} 

 \textcolor{red}{-Was not able to find opioid stat for 4 weeks} \\
To adjust the first percentage to a 4 week percentage, \\
\textcolor{red}{-could not find any sort of relapse rate graph over time \\
-could not find any acute stage withdrawal sources that suggested the distribution of relapsing individuals in the weeks following treatment} 
 ...
 \textcolor{red}{These percentages are ``relapse rates" so that means they are going back to where they started. Should we make the assumption that's the case, and find source to see if people usually go back to primary drug of choice when relapse to support this? However, would this require the breaking up of the recovered class into two separate classes?}\\
