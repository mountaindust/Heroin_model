...
The solver returns the solution, the value of the objective function at the solution, and an exitflag in which a positive value of the latter means that a local minimum has been found. \textcolor{blue}{I think this is a stoping criteria for fmincon, look more at tolerances/stopping criteria in matlab documentation} %fmincon
